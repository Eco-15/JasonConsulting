      ...
      <div className="flex items-center justify-between px-4 sm:px-6 mb-4">
        ...
        <div className="hidden sm:flex items-center gap-2">
          ...
          <button
            ...
            className={cn(
              "p-2 rounded-full border gold-border bg-card text-card-foreground transition-all duration-300 disabled:opacity-30 disabled:cursor-not-allowed hover:gold-gradient hover:text-gray-900"
            )}
          >
